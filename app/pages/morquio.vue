...
// Preluăm datele din fișierul MD
const { data: page } = await useAsyncData(`content-morquio-${locale.value}`, () =>
    queryCollection('content').path(`/${locale.value}/morquio`).first()
)
</script>
